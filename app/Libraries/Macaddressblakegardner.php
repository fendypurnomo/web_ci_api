...
class Macaddressblakegardner
{
  ...
  */
  public static function setFakeMacAddress($interface, $mac = null)
  {
    ...
    if (!self::validateMacAddress($mac)) { $mac = self::generateMacAddress(); }
    ...
    if (self::getCurrentMacAddress($interface) == $mac) { return true; }
  ...
  */
  public static function getCurrentMacAddress($interface)
  {
    ...
    if (isset($ifconfig[0])) { return trim(strtoupper($ifconfig[0])); }
    return false;
  }
